...
,p_plug_name=>'CorlixHub'
,p_static_id=>'corlixhub'
...
,p_button_plug_id=>wwv_flow_imp.id(10021767532229802)
,p_button_name=>'LOGIN'
,p_static_id=>'login'
...
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(10021767532229802)
,p_prompt=>'Password'
...
,p_page_process_id=>wwv_flow_imp.id(10023707934229820)
,p_page_id=>9999
,p_name=>'p_password'
,p_direction=>'IN'
...
,p_page_process_id=>wwv_flow_imp.id(10025610037229827)
,p_page_id=>9999
,p_name=>'p_consent'
,p_direction=>'IN'
,p_data_type=>'BOOLEAN'
